...
export default function ProductList() {
  ...
  return (
    <div className="container mx-auto relative lg:my-40">
      ...
      <div className="flex justify-center mt-8 gap-4">
        <button
          ...
          className="w-10 h-10 rounded-full bg-red-600 text-white hover:bg-red-700 transition-all shadow-md flex items-center justify-center disabled:opacity-50"
        >
